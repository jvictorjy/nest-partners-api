...
-- CreateTable
CREATE TABLE `ReservationHitory` (
    `id` VARCHAR(191) NOT NULL,
    `email` VARCHAR(191) NOT NULL,
    `ticketKind` ENUM('full', 'half') NOT NULL,
...
-- AddForeignKey
ALTER TABLE `ReservationHitory` ADD CONSTRAINT `ReservationHitory_spotId_fkey` FOREIGN KEY (`spotId`) REFERENCES `Spot`(`id`) ON DELETE RESTRICT ON UPDATE CASCADE;
